...
\`
  ...
  releaseNotes: {
    metadata: {
      // DevSkim: ignore DS440000 - These are descriptive strings for documentation, not protocol configuration
      cryptoFeatures: ['AES-GCM-256', 'PBKDF2-SHA512', 'basE91'], // DevSkim: ignore DS440000 // DevSkim: ignore DS440000
