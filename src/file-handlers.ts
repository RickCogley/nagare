...
export const BUILT_IN_HANDLERS: Record<string, FileHandler> = {
  ...
  "markdown": {
    ...
    patterns: {
      ...
      shieldsBadge:
        /(?:https?:\/\/)?shields\.io\/badge\/version-([^-]+)-(?:blue|green|red|yellow|orange|brightgreen|lightgrey)/g, // DevSkim: ignore DS137138 // DevSkim: ignore DS137138
      imgShieldsBadge:
        /(?:https?:\/\/)?img\.shields\.io\/badge\/v(?:ersion)?-([^-]+)-(?:blue|green|red|yellow|orange|brightgreen|lightgrey)/g, // DevSkim: ignore DS137138 // DevSkim: ignore DS137138
      npmBadge: /npm\/v\/([^/\s)]+)/g,
...
export class PatternBuilder {
  ...
  static versionBadge(badgeService: "shields.io" | "img.shields.io" | "any" = "any"): RegExp {
    if (badgeService === "shields.io") {
      return /(?:https?:\/\/)?shields\.io\/badge\/version-([^-]+)-(?:blue|green|red|yellow|orange|brightgreen|lightgrey)/g; // DevSkim: ignore DS137138 // DevSkim: ignore DS137138
    }
    if (badgeService === "img.shields.io") {
      return /(?:https?:\/\/)?img\.shields\.io\/badge\/v(?:ersion)?-([^-]+)-(?:blue|green|red|yellow|orange|brightgreen|lightgrey)/g; // DevSkim: ignore DS137138 // DevSkim: ignore DS137138
    }
