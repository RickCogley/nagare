---
title: "NagareConfig Reference"
---

## Overview

The NagareConfig interface defines all configuration options for Nagare. Configuration is typically provided via a
...
NagareConfig is the main configuration interface that controls all aspects of Nagare's behavior, from version file
generation to release workflows. It requires minimal configuration (project info and version file) but supports
extensive customization through optional properties.
