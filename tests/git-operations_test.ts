 ...
 *
 * See GitHub issue: https://github.com/RickCogley/nagare/issues/[TODO: create issue for git i18n test failures] // DevSkim: ignore DS162086
 */
...
Deno.test({
  ...
  if (!Deno.env.get("CI")) {
    ...
    console.warn(
      "   See: https://github.com/RickCogley/nagare/issues/[TODO: create issue for git i18n test failures]", // DevSkim: ignore DS162086
    );
  }
